      ...
      <div className="section-padding bg-white text-center">
        <div className="container-custom">
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            Looking to sell your car? Mavullamma Cars makes it simple and hassle-free. Get a fair valuation and a quick, secure sale with our streamlined process and dedicated team.
          </p>
        </div>
      </div>
